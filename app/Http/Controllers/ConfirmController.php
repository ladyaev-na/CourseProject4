...
{
    // Метод для полного подтверждения доступности
    ...
    // Метод для полной отмены доступности
    ...
    // Метод для частичного подтверждения доступности
    ...
    // Метод для частичной отмены доступности
    ...
    // Метод для объединения соседних доступностей по времени и пользователю
